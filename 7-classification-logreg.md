...
### Мощный линейный классификатор с вероятностной интерпретацией

![bg right:40% w:400](images/sigmoid_boundary.jpg)
...
*   **Интерпретация:** `0.5` — случайный классификатор, `1.0` — идеальный.

![bg right:40% w:95%](images/roc.jpg)
...
![bg right:40% w:95%](images/sigmoid_plot.jpg)
...
*   **Вывод:** LR — лучший выбор, когда нужна **вероятность** и **интерпретация**.
...
![bg opacity:0.2](images/thank_you.jpg)