...
*   **Обучение:** Метод просто **запоминает** все существующие обучающие данные (instance-based).
...
![bg right:40%](https://erikbern.com/assets/2015/09/scatter-nns-20-1024x793.png)
...
![bg right:45% w:600](https://www.jcchouinard.com/wp-content/uploads/2021/08/image-8.png)
...
---
![bg](https://weaviate.io/assets/images/hero-88853b1677e0e7c29494a1f2c2b35c66.png)
...
* По сути, это попытка построить приближённую аналитическую формулу распределения случайной величины на основе имеющейся выборки
...
![w:800](https://www.researchgate.net/publication/262949552/figure/fig1/AS:296384596070402@1447675002316/Density-distribution-by-histogram-and-KDE-approximation-on-the-Norton-Disney-site-showing.png)
...
![bg right:50% w:650](https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Kernel_density.svg/640px-Kernel_density.svg.png)
...
![bg right:47% w:600](https://miro.medium.com/v2/resize:fit:1400/1*2_IV9Mg3rDmzL3ssCnW0UA.png)
