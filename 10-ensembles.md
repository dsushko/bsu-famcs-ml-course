...
* Одиночное дерево решений может переобучиться на один конкретный признак и придавать ему особую важность, хотя в данных такое хорошее разбиение могло получиться *случайно*
...
*   **2. Feature Bagging:** При построении *каждого узла* для поиска лучшего разбиения рассматривается **случайное подмножество признаков и наблюдений** (`например, m = sqrt(n_features)`).
...
![bg right:30% w:350](https://neerc.ifmo.ru/wiki/images/thumb/0/00/Golf-MSE.png/700px-Golf-MSE.png)
...
![bg w:75%](https://miro.medium.com/v2/resize:fit:1388/1*D7yMZ7DOFssSGSIlcPFoSw.png)
...
![bg right:40% w:500](https://codefinity-content-media.s3.eu-west-1.amazonaws.com/Ensemble_course_content/stacking_ensenble.png)
