...
![bg right:40% w:500](https://upload.wikimedia.org/wikipedia/commons/thumb/f/f3/CART_tree_titanic_survivors.png/640px-CART_tree_titanic_survivors.png)
...
![bg right:40% w:500](https://miro.medium.com/v2/1*z7tK94rGGIy_42UpiqilLQ.png)
...
![bg right w:400](https://www.researchgate.net/publication/351514990/figure/fig5/AS:1040990244724737@1625202823082/Gini-impurity-and-entropy-for-binary-classification-as-a-function-of-the-percentage-of.png)
...
![bg right w:700](https://tjmachinelearning.com/lectures/1718/rf/decisiontreeoverfit.png)
...
*   🔴 **Склонны к переобучению.** Требуют аккуратной настройки гиперпараметров.
...
*   🔴 **Плохая работа с линейными зависимостями:** Деревья не умеют строить тренды
*   🔴 **Проблемы с экстраполяцией:** Не могут предсказывать значения вне диапазона training data.
![bg right w:600](https://www.cs.cornell.edu/courses/cs4780/2018fa/lectures/images/lec17/id3overfit.png)
...
![bg right w:400](https://arize.com/wp-content/uploads/2021/09/global-feature-importance-age-most-important.png)
...
![bg right w:600](https://i.sstatic.net/jhLHV.png)
